...
static const char *fonts[] = {
    "JetBrains Mono:size=9", "FontAwesome6Brands:size=9:antialias:true",
    "FontAwesome6Free:size=9:antialias:true",
    "FontAwesome6Free:style=Solid:size=9:antialias:true"};
...
static const char *dmenucmd[] = {"dmenu_run", "-p",  "dmenu:",    "-m",
